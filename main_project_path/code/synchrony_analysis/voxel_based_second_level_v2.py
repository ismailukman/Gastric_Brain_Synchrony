...
nib.save(image_4d, f'{main_project_path}/derivatives/brain_gast/fsl_randomize/4d.nii.gz')
...
rand = fsl.Randomise(in_file=os.path.abspath(f'{main_project_path}/derivatives/brain_gast/fsl_randomize/4d.nii.gz'),
                     ...
                     base_name = os.path.abspath(f'{main_project_path}/derivatives/brain_gast/fsl_randomize/result' + clean_level + '_'),
